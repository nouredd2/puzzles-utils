...
tb-make-soft-vtype attacker1 {MicroCloud pc3000 pc3060 pc2133 pc2133x pc2133n}
...
for {set i 1 } {$i <= 5 } { incr i } {   
        ...
        tb-set-hardware $clientnode($i) attacker1
...
tb-set-hardware $router1 MicroCloud

set router2 [$ns node] 
tb-set-node-startcmd $router2 "$magi_start"
tb-set-hardware $router2 MicroCloud

set router3 [$ns node] 
tb-set-node-startcmd $router3 "$magi_start"
tb-set-hardware $router3 MicroCloud
